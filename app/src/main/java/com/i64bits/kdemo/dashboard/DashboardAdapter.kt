...
class DashboardAdapter(private var demos: ArrayList<DashboardModel>): RecyclerView.Adapter<DashboardAdapter.DViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: DashboardAdapter.DViewHolder, position: Int) = holder.bind(demos.get(position))
